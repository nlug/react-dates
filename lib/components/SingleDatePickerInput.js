...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  showDefaultInputIconRight: _propTypes2['default'].bool,
  customInputIconRight: _propTypes2['default'].node,
    ...
    value: function () {
      function render() {
        ...
        var _props = this.props,
            ...
            showDefaultInputIconRight = _props.showDefaultInputIconRight,
            ...
            customInputIconRight = _props.customInputIconRight,
            isRTL = _props.isRTL;

        var inputIcon = customInputIcon || _react2['default'].createElement(_calendar2['default'], null);
        var inputIconRight = customInputIconRight || _react2['default'].createElement(_calendar2['default'], null);
        ...
        }), (showDefaultInputIconRight || customInputIconRight !== null) && _react2['default'].createElement('button', {
          type: 'button',
          className: 'SingleDatePickerInput__calendar-icon input-icon-right',
          disabled: disabled,
          'aria-label': phrases.focusStartDate,
          onClick: onFocus
        }, inputIconRight), showClearDate && _react2['default'].createElement('button', {
          type: 'button',
